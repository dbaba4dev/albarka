...
<div class="card card-custom bg-gray-100 {{ @$class }}">
    ...
    <div class="card-body p-0 position-relative overflow-hidden">
        ...
        <div class="card-spacer mt-n25">
            {{-- Row --}}
            <div class="row m-0">
                <div class="col-md-3 bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                ...
                <div class="col-md-3 bg-light-primary px-6 py-8 rounded-xl mr-7 mb-7">
                ...
                <div class="col-md-3 bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
                ...
                <div class="col-md-2 bg-light-success px-6 py-8 rounded-xl mb-7">
